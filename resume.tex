...
\begin{center}
    {\Huge \scshape Abram Perdanaputra Situmorang} \\ \vspace{1pt}
    \small \raisebox{-0.1\height}\faPhone\ +6281298811177 ~ \href{mailto:abram.perdanaputra@gmail.com}{\raisebox{-0.2\height}\faEnvelope\  \underline{abram.perdanaputra@gmail.com}} ~ 
    \href{https://linkedin.com/in/abrampers/}{\raisebox{-0.2\height}\faLinkedin\ \underline{linkedin.com/in/abrampers}}  ~
    \href{https://github.com/abrampers}{\raisebox{-0.2\height}\faGithub\ \underline{github.com/abrampers}}
    \vspace{-8pt}
\end{center}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Institut Teknologi Bandung}{August 2016 -- October 2022}
      {Bachelor of Engineering in Computer Science; GPA: 3.86 / 4.0}{Bandung, Indonesia}
